...
from metagpt.actions import  Topic_Summary
from metagpt.actions.write_prd_1 import  WritePRD1 as WritePRD
from metagpt.actions.prepare_documents_1 import PrepareDocuments1 as PrepareDocuments
...
class ProductManager1(Role):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self._watch([Topic_Summary,PrepareDocuments])
